                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="/MomAndBaby/admin/account">
        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="table-responsive" style="padding: 5px;">
                    ...
                    <form method="post" action="/MomAndBaby/admin/account">
                                ...
                                <c:forEach items="${accounts}" var="account">
                                    <c:if test="${account.username != sessionScope.usernameAdmin}">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="label label-success">${account.roleName}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="box-action">
                                                <a href="/MomAndBaby/admin/account/update/${account.ID}" class="active btn-action green">
                                                    <i class="bx bx-edit"></i>
                                                </a>
                                                <a onclick="return confirm('Are you sure to delete?')" 
                                                   href="/MomAndBaby/admin/account/delete/${account.ID}" 
