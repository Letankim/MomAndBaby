<%-- 
    Document   : brand
    Created on : May 17, 2024, 5:59:32 PM
    Author     : HP
--%>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="/MomAndBaby/admin/brand" enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
                ...
                <div class="row w3-res-tb">
                    <div class="col-sm-5 m-b-xs">
                        ...
                        <span class="message-notice"> <span>*</span> Can not delete brand that having product</span>
                    </div>
                </div>
                <div class="table-responsive" style="padding: 5px;">
                    ...
                    <form method="post" action="/MomAndBaby/admin/brand">
                            ...
                            <tbody class="render-data">
                                <c:forEach items="${brands}" var="brand">
                                    <tr>
                                        ...
                                        <td class="box-action">
                                            <a href="/MomAndBaby/admin/brand/update/${brand.ID}" class="btn-action green">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a onclick="return confirm('Are you sure to delete?')" 
                                               href="/MomAndBaby/admin/brand/delete/${brand.ID}" 
