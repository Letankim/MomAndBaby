                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="/MomAndBaby/admin/producer">
        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="table-responsive" style="padding: 5px;">
                    ...
                    <form method="post" action="/MomAndBaby/admin/producer">
                            ...
                            <tbody class="render-data">
                                <c:forEach items="${producers}" var="producer">
                                    <tr>
                                        ...
                                        <td class="box-action">
                                            <a href="/MomAndBaby/admin/producer/update/${producer.ID}" class="btn-action green">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a onclick="return confirm('Are you sure to delete?')" 
                                               href="/MomAndBaby/admin/producer/delete/${producer.ID}" 
