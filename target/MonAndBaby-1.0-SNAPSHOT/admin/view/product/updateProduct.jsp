    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="gallery">
                ...
                <a class="btn btn-info btn-back-to-page" href="/MomAndBaby/admin/product"><< Back to product</a>
                <div class="box-content">
                    <form class="cmxform form-horizontal form-validate" accept-charset="UTF-8" method="post" action="/MomAndBaby/admin/product" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <input id="available" value="${product.quantity}" name = "quantity" class=" form-control" required>
