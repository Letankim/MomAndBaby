                                        ...
                                        <div class="modal-dialog" style="width: 90%">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form accept-charset="UTF-8" method="post" action="/MomAndBaby/admin/product" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="available" required type="number" name="quantity" class="form-control">
                                                            <span class="message_error"></span>
                                                        </div>
                                                        <div class="form-group">
        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="table-responsive" style="padding: 5px;">
                    ...
                    <form method="post" action="/MomAndBaby/admin/product">
                            ...
                            <tbody class="render-data">
                                <c:forEach items="${products}" var="product">
                                    <tr>
                                        ...
                                        <td class="box-action">
                                            <a href="/MomAndBaby/admin/product/view/${product.ID}" class="btn-action blue" title="Detail">
                                                <i class='bx bx-slider'></i>
                                            </a>
                                            <a href="/MomAndBaby/admin/product/comment/${product.ID}" class="btn-action red" title="Comment">
                                                <i class='bx bxs-comment-detail'></i>
                                            </a>
                                            <a href="/MomAndBaby/admin/product/update/${product.ID}" class="btn-action green" title="Edit">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a onclick="return confirm('Are you sure to delete?')" 
                                               href="/MomAndBaby/admin/product/delete/${product.ID}" 
