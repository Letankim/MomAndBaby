                ...
                <ul class="nav pull-right top-menu">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <li>
                                <a href="/MomAndBaby/staff/account/personal/${staffLogin.username}">
                                    <i class='bx bxs-user'></i>
                                    Personal
                                </a>
                            </li>
                            <li onclick="return confirm('Are you sure to logout?')">
                                <a href="/MomAndBaby/staff?logout=true">
            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li>
                            <a href="/MomAndBaby/staff">
                                <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="/MomAndBaby/staff/mail">
                                <span>Mail</span>
                            </a>
                        </li>
                        <li>
                            <a href="/MomAndBaby/staff/voucher">
                                <span>Voucher</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/MomAndBaby/staff/banner">
                                <span>Banner</span>
                            </a>
                        </li>
                        <li>
                            <a href="/MomAndBaby/staff/product">
                                <span>Product</span>
                            </a>
                        </li>               
                        <li>
                            <a href="/MomAndBaby/staff/account">
                                <span>Account</span>
                            </a>
                        </li>
                    </ul>            
