                ...
                <section class="panel">
                    ...
                    <c:set var="account" value="${account}"></c:set>
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal" method="post" action="/MomAndBaby/staff/account">
                                ...
                                <a class="btn btn-info btn-back-to-page" href="/MomAndBaby/admin/account"><< Back to account</a>
                            </div>
                        </div>
                    </section>
                </div>
