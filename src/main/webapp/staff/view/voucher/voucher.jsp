...
<section id="main-content">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="/MomAndBaby/staff/voucher">
        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="table-responsive" style="padding: 5px;">
                    ...
                    <form method="post" action="/MomAndBaby/staff/voucher">
                            ...
                            <tbody class="render-data">
                                <c:forEach items="${vouchers}" var="voucher">
                                    <tr>
                                        ...
                                        <td class="box-action">
                                            <a href="/MomAndBaby/staff/voucher/update/${voucher.id}" class="btn-action green">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a onclick="return confirm('Are you sure to delete?')" 
                                               href="/MomAndBaby/staff/voucher/delete/${voucher.id}" 
    ...
    <script>
                                                ...
                                                const inputsToValidate = [
                                                    ...
                                                    {element: limit, message: messageLimit, regex: /^[0-9]+(?:\.[0-9]+)?$/, type: "text", isEmpty: false},
