                        ...
                        <table id="product" class="table table-striped b-t b-light">
                            ...
                            <c:forEach items="${products}" var="product" varStatus="index">
                                    <tr>
                                        ...
                                        <td class="box-action">
                                            <a href="/MomAndBaby/staff/product/view/${product.ID}" class="btn-action blue" title="Detail">
                                                <i class='bx bx-slider'></i>
                                            </a>
                                            <a href="/MomAndBaby/staff/product/comment/${product.ID}" class="btn-action red" title="Comment">
