<%-- 
    Document   : index.js
    Created on : May 17, 2024, 9:19:06 AM
    Author     : HP
--%>
            ...
            <div class="row">
                ...
                <c:forEach items="${categories}" var="cate" varStatus="i">
                    <p style="${i.index == 0 ? "margin-top: 20px" : ""}">
                        <a href="/MomAndBaby/product/?type=category&id=${cate.ID}">${cate.name}</a>
                    </p>
                </c:forEach>
            </div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="/MomAndBaby/product/detail/${productDeal.ID}">${productDeal.name}</a>
                                            </h3>
                                        ...
                                        <div class="add-to-cart">
                                            <a class="add-to-cart-btn" href="/MomAndBaby/cart/add?productID=${productDeal.ID}&quantity=1&pathUrl=/MomAndBaby">
                    ...
                    <c:forEach items="${brands}" var="br">
                        <div class="col-md-2">
                            <div
                                ...
                                >
                                <a href="/MomAndBaby/product?type=brand&id=${br.ID}">
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <c:forEach items="${productsFeature}" var="productFeature">
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="/MomAndBaby/product/detail/${productFeature.ID}">${productFeature.name}</a>
                                            </h3>
                                            <h4 class="product-price">
                                                <c:if test="${productFeature.newPrice > 0}">
                                        ...
                                        <div class="add-to-cart">
                                            <a class="add-to-cart-btn" href="/MomAndBaby/cart/add?productID=${productFeature.ID}&quantity=1&pathUrl=/MomAndBaby">
                                                <i class="fa fa-shopping-cart"></i> add to cart
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hot-deal">
                    ...
                    <a class="primary-btn cta-btn" href="/MomAndBaby/product">Shop now</a>
                </div>
            </div>
        </div>
        <!-- /row -->
                            ...
                            <div class="products-slick" data-nav="#slick-nav-2">
                                <c:forEach items="${productsNormal}" var="productNormal">
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name">
                                                <a href="/MomAndBaby/product/detail/${productNormal.ID}">${productNormal.name}</a>
                                            </h3>
                                            <h4 class="product-price">
                                                <c:if test="${productNormal.newPrice > 0}">
                                        ...
                                        <div class="add-to-cart">
                                            <a class="add-to-cart-btn" href="/MomAndBaby/cart/add?productID=${productNormal.ID}&quantity=1&pathUrl=/MomAndBaby">
                                                <i class="fa fa-shopping-cart"></i> add to cart
                                            </a>
                                        </div>
                                    </div>
...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="section">
                <h3 style="margin-left: 18px">New Arrival</h3>
            </div>
            <div class="col-md-6">
                <div class="shop">
                    <div class="shop-img">
