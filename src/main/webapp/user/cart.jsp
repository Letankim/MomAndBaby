<%-- 
    Document   : cart
    Created on : May 20, 2024, 1:06:42 PM
    Author     : HP
--%>
...
<div class="section">
    ...
    <div class="container">
        ...
        <form action="/MomAndBaby/cart" method="post">
            ...
            <div class="order-summary">
                <div class="order-products">
                    <div class="order-col">
                        <div>
                            <a href="/MomAndBaby/product" style="padding: 10px">
                                <strong>Return to shop</strong>
                            </a>
                        </div>
                        <div>
                            <button name="btn-update-cart" style="padding: 10px">
        ...
        <div class="row" style="margin-top: 40px">
            <form action="/MomAndBaby/voucher" method="post" id="couponForm">
                <div class="col-md-6" style="right: 15px; margin-top: 10px">
                    ...
                    <div class="form-group">
                        <button
                            ...
                            name="use-voucher"
                            style="padding: 10px; color: #fff; background-color: #db4444"
                            >
                            Apply Coupon
                        </button>
                    </div>
                    <% String couponStatus = (String) session.getAttribute("couponStatus"); %>
                    <% if ("invalid".equals(couponStatus)) { %>
                    <p style="color: red;">Invalid coupon code.</p>
                    <% } else if ("expired".equals(couponStatus)) { %>
                    <p style="color: red;">Coupon has expired.</p>
                    <% } else if ("limitReached".equals(couponStatus)) { %>
                    <p style="color: red;">Coupon usage limit reached.</p>
                    <% } else if ("applied".equals(couponStatus)) { %>
    ...
    function confirmRemove(cartId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "/MomAndBaby/cart/remove?cartId=" + cartId;
            }
        });
    }
</script>
