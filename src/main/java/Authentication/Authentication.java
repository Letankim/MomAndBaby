...
//            if (session != null && userRole != null && userRole.equals("admin") && usernameAdmin != null) {
...
//            return;
//        }
//        if (session == null || userRole == null || usernameAdmin == null) {
//            httpResponse.sendRedirect(httpRequest.getContextPath() + "/admin/login");
//        } else {
//            if ("admin".equals(userRole) && usernameAdmin != null) {
//                chain.doFilter(request, response);
//            } else {
