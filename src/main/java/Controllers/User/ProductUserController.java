...
public class ProductUserController extends HttpServlet {
    ...
    private static final int numberProductInPage = 2;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.endsWith("/MomAndBaby/product/") || path.endsWith("/MomAndBaby/product")) {
            this.productPage(request, response, 1, numberProductInPage);
        } else if (path.startsWith("/MomAndBaby/product/page-")) {
        ...
        }  else if (path.startsWith("/MomAndBaby/product/detail/")) {
            String paths[] = path.split("/");
