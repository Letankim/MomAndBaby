...
//        if (auth.isLogigAdminWithHighPermission(request)) {
    ...
    private void getCurrentAccountUpdatePersonal(HttpServletRequest request, HttpServletResponse response, String username) {
        try {
            ...
            if (session.getAttribute("usernameStaff").equals(username)) {
    ...
    private void updateAccount(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (!isEmail) {
                ...
                Account a = new Account(id, username, passwordHashing, email, phone, status, fullname, null, role, null);
...
//     get information from form
            ...
            if (!isEmail) {
                ...
                int role = validate.getInt(request.getParameter("role"));
                int status = validate.getInt(request.getParameter("status"));
                Account aUpdate = new Account(id, username, passwordHashing, email, phone, status, fullname, null, role, fileName);
